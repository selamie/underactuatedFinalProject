...
class InertialWheelPendulumVisualizer(PyPlotVisualizer):
    ...
    def __init__(self, inertial_wheel_pendulum):
        ...
        self.arm = self.ax.fill(self.arm_pts[0, :], self.arm_pts[1, :], zorder=1, facecolor=(.9, .4, .6), edgecolor='k', closed=True)
        ...
        self.flywheel_crossbar = self.ax.fill(self.flywheel_crossbar_pts[0, :], self.flywheel_crossbar_pts[1, :]+self.flywheel_crossbar_offset, zorder=3, facecolor=(.9, .4, .6), edgecolor='k', closed=True)
        ...
        self.flywheel_disc = self.ax.fill(self.flywheel_disc_pts[0, :], self.flywheel_disc_pts[1, :], zorder=3, facecolor=(.9, .4, .6), edgecolor='k', closed=True)
